    ...
    docInfo && (
      <div className="flex flex-col">
        ...
        <div className="lg:ml-[320px] mb-20">
          ...
          <button className="bg-primary px-10 py-3 rounded-full mt-6 text-white hover:scale-110 transition-all ease-in-out duration-500">Book an Appointment</button>
        </div>
