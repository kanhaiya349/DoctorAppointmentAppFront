...
function Header() {
  return (
    <div className="bg-primary flex flex-col md:flex-row justify-between px-6 md:px-8 lg:px-16 rounded-xl pt-6">
        {/* Left Side */}
        <div className="md:w-1/2 flex flex-col gap-5 justify-center items-center md:items-start m-auto">
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 mt-1">
                <img className="w-28 h-full" src={assets.group_profiles} alt="" />
            ...
            <a href="#speciality" className="mx-auto md:mx-0 w-[181px] my-2 mb-2 py-3 rounded-full flex justify-center items-center w-full bg-white gap-2 text-sm text-[#404040] hover:scale-110 transition-all ease-in-out duration-700">
        ...
        <div className="md:w-1/2 relative flex items-end">
            <img src={assets.header_img} className="w-full rounded-lg h-auto object-cover" alt="" />
        </div>
    </div>
  )
}
