    ...
    <div className="flex flex-col">
        <div className="border-b mb-5 pb-6 border-grey-300 flex flex-col md:flex-row justify-between">
            <div className="md:w-1/3">
                ...
                <p className="text-sm text-[#5C5C5C] font-normal">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            </div>
            <div className="lg:ml-20">
                ...
                <p onClick={()=>{navigate("/delivery");scrollTo(0,0)}} className="text-sm text-[#5C5C5C] font-semibold mb-2 cursor-pointer hover:text-primary transition-all ease-in-out duration-500">Delivery</p>
                <p onClick={()=>{navigate("/privacy-policy");scrollTo(0,0)}} className="text-sm text-[#5C5C5C] font-semibold mb-2 cursor-pointer hover:text-primary transition-all ease-in-out duration-500">Privacy Policy</p>
            </div>
