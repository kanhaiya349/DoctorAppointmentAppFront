      ...
      <div className="flex text-center items-center gap-4">
        {token ? (
          <div className="flex h-full item-center gap-2 cursor-pointer relative group">
            ...
            >
              <div className="z-1 bg-white shadow-3xl flex flex-col item-center h-[100%]">
                <p
          ...
          <button
            ...
            className="bg-primary h-[100%] text-white px-5 md:px-8 md:py-3 text-[12px] rounded-full"
          >
            Log in
          </button>
        )}
