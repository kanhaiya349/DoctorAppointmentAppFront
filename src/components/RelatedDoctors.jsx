...
function RelatedDoctors({docId,speciality}) {
  ...
  return (
    <div className="mb-20">
        <h3 className="text-3xl font-semibold mb-5 text-center">Related Doctors</h3>
        <p className="text-center text-sm mb-5">Simply browse through our extensive list of trusted doctors.</p>
